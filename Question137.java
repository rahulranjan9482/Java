// Q:- Write a java program to create an array from a given array of integers .The newly created array will contain elements from the given array
// after the last element value is 10.
import java.util.*; 
import java.io.*; 
